...
/*
//SETS TIME
if( (chk_buttons(7) == TRUE) ){mode ^= ( 1 << 3);} //toggle mode and LED to light up on bar graph

//SETS ALARM
if( (chk_buttons(0) == TRUE) ){mode ^= (1 << 6);}// toggle mode and LED to light up on the bar graph


//SNOOZE ALARM
if( (chk_buttons(3) == TRUE) ) { mode ^= ( 1 << 2);
